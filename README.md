...
>
> 本仓库 **20020127/SwiftBackupPrem-zh** 仅是上游项目的**简体中文本地化分支**，未改写核心功能逻辑。所有功能版权归原作者所有；若原作者不同意本分支公开，请联系删除。
...
- **[Juby210](https://github.com/Juby210)** — **SwiftBackupPrem 原作者 / Original Author**
- **[s1ddhants1](https://github.com/s1ddhants1)** — 上游维护者 / Upstream Maintainer
...
本简体中文分支由 **20020127** 维护，仅做界面与文档本地化，功能版权归原作者。
...
- 界面字符串：`app/src/main/res/values-zh/strings.xml` 与 `values-zh-rCN/strings.xml`
- 系统语言为中文（简体/繁体）时，应用会自动显示中文界面
- 原作者：[Juby210](https://github.com/Juby210) · 上游维护者：[s1ddhants1](https://github.com/s1ddhants1)
- 上游项目：[s1ddhants1/SwiftBackupPrem](https://github.com/s1ddhants1/SwiftBackupPrem)
- APK 下载：[Releases](../../releases/latest)
